(ns aoc.2017.day5.twisty-trampolines
  (:require [clojure.test :refer [deftest is]]))

(defn jump [[pos offsets]]
  [(+ pos (nth offsets pos))
...
(defn steps-twisty-trampoline-acc
  ...
  (if (>= pos (count offsets))
    acc
    (recur (inc acc) (jump twisty-trampoline))))

(defn steps-twisty-trampoline
  [twisty-trampoline]
  (steps-twisty-trampoline-acc 0 twisty-trampoline))

;;solution 2 loop
(defn steps-twisty-trampoline-loop
  [twisty-trampoline]
  (loop [acc 0
